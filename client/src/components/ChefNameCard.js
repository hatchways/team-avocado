...
export default function Namecard({ chef }) {
  ...
  const [values, setValues] = useState({
    ...
    desc:
      "Chef with 8 years in Japanese cuisine. Reciepient of awards and positive feedback "
  });
    ...
    <div className={classes.wrap}>
      <Switch>
        ...
        <Route path="/chef/:chef_id">
          <img className={classes.profileimg} alt="profile" src={chef.avatar} />
        </Route>
      </Switch>
      <Container>
        <Switch>
          ...
          <Route path="/chef/edit/:chef_id">
            <form className={classes.form}>
              ...
              <label htmlFor="background-img-file">
                <Tooltip
                  title="Click to upload new background"
                  placement="top-start"
                >
                  <img
              ...
              <RequestButton type="submit">Save Profile</RequestButton>
            </form>
          </Route>
          <Route path="/chef/:chef_id">
            ...
            <div>
              <p className={classes.desc}>{chef.description}</p>
            </div>
            <RequestButton type="submit">Send Request</RequestButton>
          </Route>
        </Switch>
      </Container>
    </div>
